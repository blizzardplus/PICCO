...
public final class Constants {
     ...
     */
    public static final String GCM_API_KEY = "AIzaSyD2jzclUnNOxysrXmzbWVurVQH9Of0dn18";

    /**
     * Android client ID from Google Cloud console.
     */
    public static final String ANDROID_CLIENT_ID = "811318688635-78cbphbb61lgn651a2a859bohlgkggam.apps.googleusercontent.com";
